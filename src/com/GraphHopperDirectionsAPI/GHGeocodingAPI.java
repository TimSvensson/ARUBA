...
public class GHGeocodingAPI implements GeocodingInterface {
    ...
    public boolean geocode(Position position) {
        ...
        // String | If you do forward geocoding, then this would be a textual description of the adress you are looking
        // for. If you do reverse geocoding this would be in lat,lon.
        String q = position.toString();

        // String | Display the search results for the specified locale. Currently French (fr), English (en),
        // German (de) and Italian (it) are supported. If the locale wasn't found the default (en) is used.
        String locale = "en";
        ...
        // String | The location bias in the format 'latitude,longitude' e.g. point=45.93272,11.58803
        String point = "";
...
//                throw new IOException("ghGeocodeProvider is null");
        ...
        try {
            this.geocodingResult = apiInstance.geocodeGet(this.apiKey, q, locale, this.getResultLimit(), reverse, point, provider);
