...
public class OrderTest {
    ...
    public  Agent agentTestHelp1 = new Agent(positionTestHelp1 , "332", "Carl", "Eriksson", 22, 657);
    ...
    public  Agent agentTestHelp2 = new Agent(positionTestHelp2 , "333", "Tim", "Svensson", 22, 657);
